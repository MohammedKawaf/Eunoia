...
class Controller:
    def __init__(self):
        ...
        # Colors and fonts that can be used by all views
        self.COLORS = {
    ...
    # Shows the main window and hides the login view
    ...
    # Shows the sign-up view and hides the login view
    ...
    # Shows the login view and hides the sign-up and main window views
    def show_login(self):
    ...
    # Logs out the current user, closes the main window, and shows the login view
    def logout(self):
        self.current_user = None
